...
```bash
java -jar build/libs/KF2-Discord-Linker-1.1.2.jar 2424 https://killingfloor2.com/ ad2eSDSGJSU2dfd148 0 0 0 0 0
```
...
```bash
java -jar build/libs/KF2-Discord-Linker-1.1.2.jar
```